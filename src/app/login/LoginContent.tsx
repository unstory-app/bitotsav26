  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center px-4 py-24 sm:py-32 relative overflow-x-hidden w-full">
      ...
      <motion.div 
        ...
        className="w-full max-w-lg bg-black border-4 border-[#D4AF37] p-6 sm:p-12 relative shadow-[10px_10px_0px_#D4AF37] sm:shadow-[20px_20px_0px_#D4AF37] my-10 z-10"
      >
        <div className="text-center mb-12">
            <div className="flex justify-center mb-8">
                <div className="w-20 h-20 bg-[#D4AF37] flex items-center justify-center">
            ...
            <p className="text-[#D4AF37] font-black italic text-xs uppercase tracking-[0.3em] bg-white/5 py-2 inline-block px-4">BIT MESRA WEBMAIL AUTH</p>
        </div>

        {/* Webmail Notice */}
        <div className="mb-10 p-8 border-2 border-white/10 flex items-start gap-4 hover:border-[#D4AF37] transition-colors">
            ...
            <div className="text-sm">
                ...
                <p className="text-white/40 leading-relaxed font-black italic uppercase text-[10px] tracking-widest">
                    Only <span className="text-[#D4AF37]">@bitmesra.ac.in</span> domains are authorized for pass generation. 
        ...
        {/* Decorative corner */}
        <div className="absolute bottom-0 right-0 w-12 h-12 bg-[#D4AF37] -rotate-45 translate-x-6 translate-y-6" />
      </motion.div>

      <style jsx global>{`
        .stack-auth-container {
          --stack-primary: #D4AF37;
