        ...
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8 mb-12">
          <div>
            <h1 className="text-6xl font-black italic text-[#FDF5E6] uppercase tracking-tighter mb-1 select-none">
              TEAM EVENT <span className="text-[#D4AF37]">MATRIX.</span>
            </h1>
            <p className="text-[10px] text-[#D4AF37]/40 font-black uppercase tracking-[0.3em]">
              FULL PARTICIPATION MAP // TEAM TO EVENT INTELLIGENCE
            </p>
          </div>
        ...
        <div className="bg-white/2 border-2 border-white/5 relative overflow-hidden min-h-[420px]">
          {loading ? (
            ...
            <div className="p-40 flex flex-col items-center justify-center text-center space-y-4">
              ...
              <p className="text-[#FDF5E6]/30 font-black uppercase tracking-widest font-heading">NO TEAM EVENT LINKS FOUND</p>
            </div>
          ) : (
