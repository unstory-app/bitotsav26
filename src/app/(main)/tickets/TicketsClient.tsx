              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                >
                  <div className="flex items-center gap-3 text-[#8CF5B3]">
                    ...
                    <span className="text-[9px] font-black uppercase tracking-[0.35em]">MANDATORY WHATSAPP NEWS GROUP</span>
                  </div>
                  <p className="mt-3 text-[10px] font-black uppercase tracking-[0.18em] text-[#DFFFE9]/70">
                    Join this group to receive official fest news, gate updates, schedule changes, and important announcements.
                  </p>
                  <p className="mt-3 text-[9px] font-black uppercase tracking-[0.22em] text-[#8CF5B3]">
